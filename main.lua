...
local Window = OrionLib:MakeWindow({IntroText = "total chaos gui :0", IntroIcon = "rbxassetid://15315284749",Name = GameName, HidePremium = false, SaveConfig = true, ConfigFolder = "Tutorial"})
